...
class BeamSearch(DecodeStrategy):
    ...
    def advance(self, log_probs, attn):
        ...
        self.topk_scores = self.topk_scores.double()
        ...
        self._batch_index = torch.floor_divide(self.topk_ids, vocab_size)
    ...
    def update_finished(self, last_step=None):
        ...
        self.top_beam_finished |= self.is_finished[:, 0].eq(1).byte()
