...
def model_opts(parser):
    ...
    group.add('--rnn_type', '-rnn_type', type=str, default='LSTM',
              choices=['LSTM', 'GRU', 'SRU', 'GRU_hyper'],
              action=CheckSRU,
    ...
    group.add('--context_gate', '-context_gate', type=str, default=None,
              choices=['source', 'target', 'both', 'hyper'],
    ...
    group.add('--global_attention', '-global_attention',
              ...
              choices=['dot', 'general', 'mlp', 'none', "hype_symm", "hype_asymm_like", "hype_asymm_exp_exp_dire_neg_var_rec", "hype_asymm_like_rec_neg", "hype_asymm_exp_exp_dire", "hype_asymm_like_rec_square","hype_asymm_like_rec", "hype_asymm_exp_exp_dire_neg_var_cons", "hype_asymm_exp_exp_dire_neg_var", "hype_asymm_exp_rec", "hype_asymm_sht", "hype_symm_bias", "hype_asymm_exp_dire", "hype_asymm_ths", "hype_asymm_exp", "hype_asymm_plus", "hype_asymm_exp_rec"],
...
def train_opts(parser):
    ...
    group.add('--early_stopping_criteria', '-early_stopping_criteria',
              nargs="*", default=['ppl','accuracy'],
              help='Criteria to use for early stopping.')
    group.add('--optim', '-optim', default='sgd',
              choices=['sgd', 'adagrad', 'adadelta', 'adam',
                       'sparseadam', 'adafactor', 'fusedadam', 'riemannian_adam', 'riemannian_sgd'],
